...
public class StringStack {
    ...
    //    private ArrayList<T> theArray = new ArrayList<T>();
    public ArrayList<String> theArray = new ArrayList<>();
    public int size;
    ...
    public StringStack(int capacity) {
        ArrayList<String> theArray = new ArrayList<>(capacity);
    }
     ...
     */
    public StringStack() {
        ArrayList<String> theArray = new ArrayList<>(10);
    }

    /* Return true if the stack has no elements, and false otherwise.
     */
    public boolean empty() {
        if (theArray.size() == 0) return true;
        return false;
    }
